				...
				<ScrollAnimation className="space-y-6">
					...
					<ScrollAnimation>
						<div className="pt-4">
							...
							<ul className="list-none space-y-3">
								{["Based in Philippines", "Bachelor Degree in Information Technology", "AMA Computer College"].map((fact, index) => (
									<motion.li
										key={fact}
					...
					<ScrollAnimation>
						<div className="flex justify-start space-x-4">
							<a
								href="/files/cv_pdf/Dairon(CV).pdf"
								target="_blank"
